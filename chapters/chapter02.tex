...
\begin{proof}
To prove this lemma, we use the technique of barycentric subdivision. The proof is divided into four elementary steps, which initially are geometric and become more algebraic over time.
