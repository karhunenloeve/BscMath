...
\begin{lemma}[$d$-disk to $d$-simplex]
...
\begin{proof}
Let $K_1$ and $K_2$ be two geometric realizations of the abstract simplicial complex $\tilde{K}$ in $\mathbb{R}^n$. Let the vertices of $\tilde{K}$ be $\{v_1, \dots, v_d\}$. Each vertex $v_i$ is mapped to a point $p_i$ in $K_1$ and to a point $q_i$ in $K_2$. There is a bijection between the vertices of $K_1$ and $K_2$: 
\begin{align}
...
\end{align}
This sequence forms a chain complex because \( \partial_{d} \circ \partial_{d+1} = 0 \). We can then define the relative homology groups\index{relative homology group} \( H_{d}(X, A)\) as the homology groups of this chain complex and $H_\bullet(\mathcal{C}(X,A))$ as the homology of the entire chain complex, this becomes important in the Chapter \ref{PersistentHomology} on persistent homology.
...
\mathcal{A}\colon & \cdots \arrow[r] & A_{n+1} \arrow[d, "i"] \arrow[r, "\partial_{d+1}"] & A_n \arrow[d, "i"] \arrow[r, "\partial_{d}"] & A_{n-1} \arrow[d, "i"] \arrow[r, "\partial_{d-1}"] & \cdots \\
\mathcal{B}\colon & \cdots \arrow[r] & B_{n+1} \arrow[d, "j"] \arrow[r, "\partial_{d+1}"] & B_n \arrow[d, "j"] \arrow[r, "\partial_{d}"] & B_{n-1} \arrow[d, "j"] \arrow[r, "\partial_{d-1}"] & \cdots \\
\mathcal{C}\colon & \cdots \arrow[r] & C_{n+1} \arrow[d] \arrow[r, "\partial_{d+1}"]      & C_n \arrow[d] \arrow[r, "\partial_{d}"]      & C_{n-1} \arrow[d] \arrow[r, "\partial_{d-1}"]      & \cdots \\
                  &                  & 0                                                  & 0                                            & 0                                                  &       
\end{tikzcd}
\end{equation}
...
\begin{proof}{\textit{\cite[Proof of Proposition 2.21]{hatcher2005algebraic}}} The proof is divided into four steps, which initially are geometric and become more algebraic over time.
	...
	\begin{align}
		\partial_{d} S_d\lambda & = \partial_d b_\lambda(S_{d-1}\partial_{d}\lambda) \nonumber\\
		                  ...
		                  & = S_{d-1}\partial_d\lambda - b_\lambda S_{d-2}(\partial^2_d\lambda) \quad \text{since } \partial_{d} S_{d}(\partial_{d+1}\lambda) = S_{d-1}(\partial^2_{d+1}\lambda),\nonumber\\
