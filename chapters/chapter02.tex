...
\begin{proof}
	...
	\begin{align}
		\partial_d[w_0, \ldots, w_n] = \sum_{i=0}^d (-1)^i [w_0, \ldots, \hat{w_i}, \ldots, w_d], 
	\end{align}
	...
	\end{align}
	This shows the equivalence of the equations \(\partial_{d+a} b(\alpha) = \alpha - b(\partial_d \alpha)\) and \(\partial_{d+1} b + b \partial_d = \text{id}\), meaning that \(b\) is a chain homotopy between the identity map and the zero map of the chain complex \(\mathcal{LC}(Y)\).
