...
fixed field $\F$, organizing persistent (co)homology as a graded module
over $\F[x]$. Replacing $\F$ with the ring $\mathbb{Z}$ leads to substantial issues, but most of the results still hold for principal ideal domains, as discussed in \cite[\S 3.1]{zomorodian2004computing}.
