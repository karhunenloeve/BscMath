...
\]
for a finite filtration\index{filtration}, where each $C_{i} := \langle \{\sigma^{(1)}_a\}_{a \in I_1}, \{\sigma^{(2)}_a\}_{a \in I_2}, \ldots, \{\sigma^{(i)}_a\}_{a \in I_i}
...
_{ij}\in \F$ for all $i, j \in \{1, \ldots, d\}$. Then $C_{\bullet}(X_{i}) = (C_{i},\partial_{i})$ is the chain complex for the absolute
...
\]
where $C_{i}^{\flat} = \text{Hom}(C_{i}, \F) = \langle \{\sigma^{(1)\flat}_a\}_{a \in I_1},
, \{\sigma^{(2)\flat}_a\}_{a \in I_1}, \ldots, \{\sigma^{(i)\flat}_a\}_{a \in I_1} \rangle$, with the elements
$\{\sigma^{(i)\flat}_a\}_{a\in I_i}$ as the dual basis of $\{\sigma^{(i)}_a\}_{a \in I_i}$. The coboundary $\delta
...
\begin{example}
	...
	\begin{align}
		\label{matrix}
		\partial_0\sigma^{(0)}_{1} & = \partial_d\sigma^{(0)}_{2} = 0, \nonumber\\
...
\centering
\begin{tikzcd}
                                  & \vdots \arrow[d, "\partial_{d+2}"]                                   & \vdots \arrow[d, "\partial_{d+2}"]                               & \vdots \arrow[d, "\partial_{d+2}"]                                            & \vdots \arrow[d, "\partial_{d+2}"]                                   &        \\
\cdots \arrow[r, "f^{i-2}_{d+1}"] & C_{d+1}^{i-1} \arrow[r, "f^{i-1}_{d+1}"] \arrow[d, "\partial_{d+1}"] & C_{d+1}^{i} \arrow[r, "f^{i}_{d+1}"] \arrow[d, "\partial_{d+1}"] & C_{d+1}^{i+1} \arrow[r, "f^{i+1}_{d+1}", no head] \arrow[d, "\partial_{d+1}"] & C_{d+1}^{i+2} \arrow[d, "\partial_{d+1}"] \arrow[r, "f^{i+2}_{d+1}"] & \cdots \\
\cdots \arrow[r, "f^{i-2}_{d}"]   & C_{d}^{i-1} \arrow[d, "\partial_{d}"] \arrow[r, "f^{i-1}_{d}"]       & C_{d}^{i} \arrow[d, "\partial_{d}"] \arrow[r, "f^{i}_{d}"]       & C_{d}^{i+1} \arrow[d, "\partial_{d}"] \arrow[r, "f^{i+1}_{d}"]                & C_{d}^{i+2} \arrow[d, "\partial_{d}"] \arrow[r, "f^{i+2}_{d}"]       & \cdots \\
\cdots \arrow[r, "f^{i-2}_{d-1}"] & C_{d-1}^{i-1} \arrow[d, "\partial_{d-1}"] \arrow[r, "f^{i-1}_{d-1}"] & C_{d-1}^{i} \arrow[d, "\partial_{d-1}"] \arrow[r, "f^{i}_{d-1}"] & C_{d-1}^{i+1} \arrow[d, "\partial_{d-1}"] \arrow[r, "f^{i+1}_{d-1}"]          & C_{d-1}^{i+2} \arrow[d, "\partial_{d-1}"] \arrow[r, "f^{i+2}_{d-1}"] & \cdots \\
