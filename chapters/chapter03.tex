...
\cdots \arrow[r, "f^{i-2}_{k+1}"] & C_{k+1}^{i-1} \arrow[r, "f^{i}_{i-1, k+1}"] \arrow[d, "\partial_{k+1}"] & C_{k+1}^{i} \arrow[r, "f^{i+1}_{i, k+1}"] \arrow[d, "\partial_{k+1}"] & C_{k+1}^{i+1} \arrow[r, "f^{i+1}_{k+1}", no head] \arrow[d, "\partial_{k+1}"] & V_{k+1}^{i+2} \arrow[d, "\partial_{k+1}"] \arrow[r, "f^{i+2}_{k+1}"] & \cdots \\
