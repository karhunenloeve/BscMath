...
\subsubsection{Interval-Decomposable Modules}
\label{Interval-DecomposableModules}

\subsubsection{Interval-Indecomposable Modules}
\label{Interval-IndecomposableModules}
...
\subsection{Decomposition of Filtered Vector Spaces}
\label{DecompositionofFilteredVectorSpaces}

\subsection{Streamlined Modules}
\label{StreamlinedModules}
